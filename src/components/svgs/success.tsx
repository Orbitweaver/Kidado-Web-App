...
const Success = () => {
    return (
        ...
        >
            ...
            />
            <motion.g filter="url(#filter0_d_4_5762)">
                <motion.circle
                    cx="90"
                    cy="90"
                    r="64.6734"
            ...
            <motion.path
                d="M69.6484 90.4523L83.2201 104.02L110.352 76.8844"
                stroke="#465FF1"
                strokeWidth="5.42714"
                strokeLinecap="round"
            ...
            />
            <defs>
                <filter id="filter0_d_4_5762" x="21.7086" y="25.3266" width="136.583" height="136.583" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_4_5762" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_4_5762" result="shape" />
                </filter>
            </defs>
        </motion.svg>
    )
